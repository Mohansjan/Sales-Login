...
//     try {
//       // Step 1: Send data to API Platform.io table
//       const response = await axios.post('https://dev-mohansjan.gateway.apiplatform.io/v1/Email', formData, {
//         headers: {
//           'apikey': 'ZdzwOIDYW0AKYVD6BkZqyBbHcjb3pyGc',
//           'pkey': '3fcc20cdc093c0403fc55b721aab6f3c',
//           'Content-Type': 'application/json'
...
//       const emailResponse = await axios.post('https://dev-mohansjan.gateway.apiplatform.io/Email', emailData, {
//         headers: {
//           'apikey': 'ZdzwOIDYW0AKYVD6BkZqyBbHcjb3pyGc',
//           'pkey': '3fcc20cdc093c0403fc55b721aab6f3c',
//           'Content-Type': 'application/json'
...
//       console.log('Email sent to user:', emailResponse.data);

//       // Step 3: Handle UI or navigation changes after successful actions
//       console.log('Login successful:', formData);
//       alert('Login successful');
//       window.location.href = '/OrdersView';  // Redirect to OrdersView page after successful login
